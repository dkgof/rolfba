...
public class GLWallpaperService extends WallpaperService {
    ...
    private static final String TAG = "LAGL";
    ...
    public class GLEngine extends Engine {
        ...
        public Bundle onCommand(String action, int x, int y, int z, Bundle extras, boolean resultRequested) {
            return mGLThread.onCommand(action,x,y,z,extras,resultRequested);
        }

        @Override
        public void onOffsetsChanged(float xOffset, float yOffset, float xOffsetStep, float yOffsetStep, int xPixelOffset, int yPixelOffset) {
            mGLThread.onOffsetsChanged(xOffset, yOffset, xOffsetStep, yOffsetStep, xPixelOffset, yPixelOffset);
        }
    }
    ...
    public static class ComponentSizeChooser extends BaseConfigChooser {
        ...
        public ComponentSizeChooser(int redSize, int greenSize, int blueSize, int alphaSize, int depthSize,
            ...
            super(new int[]{EGL10.EGL_RED_SIZE, redSize, EGL10.EGL_GREEN_SIZE, greenSize, EGL10.EGL_BLUE_SIZE,
                        ...
                        stencilSize, EGL10.EGL_RENDERABLE_TYPE, EGL_OPENGL_ES2_BIT, EGL10.EGL_NONE});
            mValue = new int[1];
            mRedSize = redSize;
